# QVAC Business Slogan Generator

Type your business idea and an on-device AI writes a catchy slogan, with a deterministic catchiness meter.
...
Then open http://localhost:29362
